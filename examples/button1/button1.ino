/***** FILE PROFET_2_12V_Shield_Starting_Software_Button1.ino  ***********
*
* Revison: 001.00
*
...
*
* DESCRIPE :     PROFET+2 12V Arduino shield - button demo
*                Simple demo to show how to use the optional mounted push-button to switch the LEDs and outputs on the PROFET+2 Arduino shield 
*                Configuration: digital mode -> J3 closed, J2 open -> push button connected to digital GPIO D2
*                               
...
const int pushButtonAnalog = A0;  // PIN for reading the push button via Analog Input A0 (D14) (if jumper J2 is ON, the push-button and RS_1=82k and C_S1J3=100nF must be assembled)
...
void setup()
{
    ...
    // PROFET+2 Arduino Shield -> switch the output of PROFET+2 U1, U2, U3, U4 OFF and switch LED1 LED2 LED3 LED4 OFF
...
{ 
 ...
 if(millis()-time_start > timeout) // timer to trigger printing the status 
  {
...
void printStatus(void)
{
 ...
 Serial.print("  LED4: ");
 Serial.println(Shield.status_LED4); 
}
