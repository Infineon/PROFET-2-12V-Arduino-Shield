/***** FILE PROFET_2_12V_Shield_Starting_Software_Button3.ino  ***********
*
* Revison: 001.00
*
...
*                If you have no push button installed you can simulate the button while sending a character to the µC. Simply send e.g. the '+' character, '1' or 'p' 
*                with e.g the Arduino Serial Monitor to the µC board. Other characters will be ignored. Do not forget to adjust the Arduino Serial Monitor to 115200 baud. 
*                
*                Level: beginner, rookie
*
* HISTORY  :     24.10.2019 [Wulz] -> Start of Initial Version (001.00)
*
